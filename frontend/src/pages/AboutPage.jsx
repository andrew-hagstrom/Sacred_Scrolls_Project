...
function AboutPage() {
    ...
    const developers = [
        ...
        },
        {
          ...
          description: 'I am a full-stack software engineer and Marine Corps Reserve Officer with Master of Arts degrees in Greek and Latin and New Testament and a reading knowledge of Hebrew and Coptic. In graduate school, my particular area of interest was the intersection of early Christian and Greco-Roman pagan practice and belief. This pursuit led to a broader interest in comparative mythology and religion, especially as understood through the archetypes of Carl Jung or the monomyth of Joseph Campbell. I have a passion for ancient languages and texts and for making them accessible to a wider audience through the power of technology. Hence the inspiration for the Sacred Scrolls application, which brings together in one place three of the most revered religious texts in the world (the Bible, Quran, and Bhagavad Gita) and allows the user to dynamically engage with them for comparative study and reflection. On the more active side, I enjoy hiking, skateboarding, blues dancing, and playing guitar.',
