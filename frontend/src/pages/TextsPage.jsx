...
function TextsPage() {
  ...
  return (
    <Accordion defaultActiveKey={['0']} alwaysOpen>
      <Accordion.Item style={{backgroundColor:'rgb(254, 248, 231)'}} eventKey="0">
      ...
      <Accordion.Item style={{backgroundColor:'rgb(254, 248, 231)'}} eventKey="1">
      ...
      <Accordion.Item style={{backgroundColor:'rgb(254, 248, 231)'}} eventKey="2">
